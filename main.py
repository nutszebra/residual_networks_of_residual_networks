...
if __name__ == '__main__':
    ...
    model = resnet_of_resnet.ResnetOfResnet(10, N=(int(N / 3. / 2., ),) * 3, out_channels=(16 * k, 32 * k, 64 * k), p=(1.0, 0.5))
    print('Done')
    optimizer = nutszebra_optimizer.OptimizerResnetOfResnet(model, lr=lr)
    args['model'] = model
